...
public class TC06_FinishPageTest {
    ...
    @Test
    public void CheckingThanksMessege () throws IOException {
        new P01_LoginPage(getDriver())
                ...
                .clickingOnContinueButton().clickOnFinishButton();
        Assert.assertTrue(new P06_FinishPage(getDriver()).checkingMessegeCorrectness());
